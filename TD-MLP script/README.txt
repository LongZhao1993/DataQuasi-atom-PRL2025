== Building LAMMPS with the TD-KMLP code ===

LAMMPS + TD-KMLP can be built using the traditional makefile build system. Instructions for this approache is included here (make directory, respectively).
...
To compile LAMMPS + TD-KMLP with the traditional makefile approach, the dlib library must 
be compiled separately and linked with LAMMPS. 

To compile LAMMPS + TD-KMLP with make:
...
Makefile.TD-KMLP into lammps/src/MAKE/MINE.
...
This will yield the executable lammps/src/lmp_TD-KMLP.
